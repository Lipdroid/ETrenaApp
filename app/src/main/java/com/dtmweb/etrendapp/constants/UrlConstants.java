...
public class UrlConstants {
    ...
    public static String STORE_PRODUCT_LIST_URL = BASE_URL + "/api/v1/seller/products/";
    public static String GET_SUBSCRIPTION_RATE_URL = BASE_URL + "/api/v1/subscription-rate/";
